...
$string['fileexistsdialog_filemanager_cache'] = 'A file with that name has already been attached. To prevent browsers serving the old cached version, it will be saved with a new name.';
...
$string['overrideallwithnewnames'] = 'Override all with new names';
$string['overridewithnewname'] = 'Override with new name';
