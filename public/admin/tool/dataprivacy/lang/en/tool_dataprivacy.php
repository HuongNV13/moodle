...
<p>As "Create automatic data deletion requests" is enabled, a data deletion request will also be created. When the request is approved, additional data will be deleted. However, some user data may be retained for data registry compliance purposes.</p>
