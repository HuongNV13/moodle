    ...
    drop_hit: function(e) {
        ...
        Y.io(M.cfg.wwwroot + AJAXURL, {
            ...
            on: {
                ...
                complete: function() {
                    this.disable_regions_if_required();
                    require(['core_block/events'], function(blockEvents) {
                        var blockNode = document.querySelector('[data-instance-id="' + this.get_block_id(dragnode) + '"]');
                        blockEvents.notifyBlockMoved(blockNode);
                    }.bind(this));
                }
            },
            context: this
