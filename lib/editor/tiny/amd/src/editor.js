...
export const setupForTarget = async(target, options = {}) => {
    ...
    // If the editor is in a modal, we need to hide all other modals when the editor's window is opened.
    ...
    // If the editor's window is closed, we need to show all the modals back.
