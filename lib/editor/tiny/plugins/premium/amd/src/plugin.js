...
export default new Promise(async(resolve) => {
    ...
    // If we have an API key, load the Tiny Premium script along with the configuration and resolve.
    // We conditionally load the configuration because it contains items that require a valid api key.
    if (externalData.apikey) {
