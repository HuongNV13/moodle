...
export default class GenerateText extends GenerateBase {
    ...
    setupContentModal = async(templateContext) => {
        ...
        this.modalObject.setTitle(getString('textmodaltitle', 'tiny_aiplacement'));
