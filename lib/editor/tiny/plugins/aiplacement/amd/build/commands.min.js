...
/**
   ...
   */Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.getSetup=void 0,_generateimage=_interopRequireDefault(_generateimage),_generatetext=_interopRequireDefault(_generatetext);_exports.getSetup=async()=>{const[contextMenuIconText,generateImageIconText,generateTextIconText,contextMenuIconImage,generateImageIconImage,generateTextIconImage]=await Promise.all([(0,_str.get_string)("generatecontent",_common.placement),(0,_str.get_string)("generateimage",_common.placement),(0,_str.get_string)("generatetext",_common.placement),(0,_utils.getButtonImage)(_common.contextMenuIcon,_common.component),(0,_utils.getButtonImage)(_common.generateImageIcon,_common.component),(0,_utils.getButtonImage)(_common.generateTextIcon,_common.component)]);return editor=>{if(!(0,_options.isTextAllowed)(editor)&&!(0,_options.isImageAllowed)(editor))return;editor.ui.registry.addIcon(_common.contextMenuIcon,contextMenuIconImage.html),editor.ui.registry.addIcon(_common.generateImageIcon,generateImageIconImage.html),editor.ui.registry.addIcon(_common.generateTextIcon,generateTextIconImage.html);const textGenerator=new _generatetext.default(editor),imageGenerator=new _generateimage.default(editor);(0,_options.isTextAllowed)(editor)&&editor.ui.registry.addMenuItem(_common.generateTextName,{icon:_common.generateTextIcon,text:generateTextIconText,onAction:()=>{textGenerator.displayContentModal(editor)}}),(0,_options.isImageAllowed)(editor)&&editor.ui.registry.addMenuItem(_common.generateImageName,{icon:_common.generateImageIcon,text:generateImageIconText,onAction:()=>{imageGenerator.displayContentModal(editor)}});let singleButton,singleButtonTitle,generator,useContextMenu=!0;(0,_options.isTextAllowed)(editor)&&!(0,_options.isImageAllowed)(editor)?(useContextMenu=!1,singleButton=_common.generateTextIcon,singleButtonTitle=generateTextIconText,generator=textGenerator):(0,_options.isImageAllowed)(editor)&&!(0,_options.isTextAllowed)(editor)&&(useContextMenu=!1,singleButton=_common.generateImageIcon,singleButtonTitle=generateImageIconText,generator=imageGenerator),useContextMenu?editor.ui.registry.addMenuButton(_common.contextMenuName,{icon:_common.contextMenuIcon,tooltip:contextMenuIconText,fetch:callback=>callback("".concat(_common.generateImageName," ").concat(_common.generateTextName))}):editor.ui.registry.addButton(_common.contextMenuName,{icon:singleButton,tooltip:singleButtonTitle,onAction:()=>generator.displayContentModal(editor)})}}}));
