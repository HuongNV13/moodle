...
export const eventTypes = {
    ...
    /**
     * An event triggered when the editor's visibility is changed.
     *
     * @event editorVisibilityChanged
     * @type {CustomEvent}
     * @property {HTMLElement} editor
     * @property {object} detail
     * @property {Boolean} detail.hidden True when the editor should be hidden, false to show.
     */
    editorVisibilityChanged: 'core_editor/visibilityChanged',
};
...
/**
 * Trigger an event to indicate that the editor's visibilty has changed.
 *
 * @method  notifyEditorVisibilityChanged
 * @returns {CustomEvent}
 * @fires   editorVisibilityChanged
 * @param {HTMLElement} editor
 * @param {Boolean} hidden True when the editor should be hidden, false to show.
 */
export const notifyEditorVisibilityChanged = (editor, hidden) => {
    return dispatchEvent(
        eventTypes.editorVisibilityChanged,
        {
            hidden: hidden,
        },
        editor
