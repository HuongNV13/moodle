...
use core\hook\task\failed_task_max_delay;
use core_user;
use stdClass;
...
class hook_callbacks {
     ...
     *
     * @param failed_task_max_delay $hook
     */
    public static function send_failed_task_max_delay_message(failed_task_max_delay $hook): void {
        $task = $hook->get_task();
