...
Feature: MoodleNet outbound share selected activities in a course
  ...
  @javascript
  Scenario: Share course to MoodleNet bulk option only be available for user that has capability only
  ...
  Scenario: User can share selected activities in a course to MoodleNet
    ...
    And I should see "This course, including your selected activities, is being shared with MoodleNet as a resource" in the "Share to MoodleNet" "dialogue"
    And I should see "Included Activities 2 of 3" in the "Share to MoodleNet" "dialogue"
  ...
  Scenario: User can share activity directly in a course bulk mode to MoodleNet
    ...
    And I should not see "Included Activities 1 of 3" in the "Share to MoodleNet" "dialogue"
    And I click on "Share" "button" in the "Share to MoodleNet" "dialogue"
    And I switch to "moodlenet_auth" window
    And I press "Allow" and switch to main window
    And I should see "Saved to MoodleNet drafts"
