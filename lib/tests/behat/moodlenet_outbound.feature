...
Feature: MoodleNet outbound send activity
  ...
  @javascript
  Scenario: User can see their shared course on the MoodleNet share progress page
    ...
    Then I should see "Test course 1" in the "Test course 1" "table_row"
    And I should see "Course" in the "Test course 1" "table_row"

  @javascript
  Scenario: User can see their shared activity on the MoodleNet share progress page
    Given I am on the "C1" course page logged in as teacher1
    When I navigate to "MoodleNet share progress" in current page administration
    And I should see "There are no shared resources to display at this time"
    ...
    And I am on "C1" course homepage
    And I navigate to "MoodleNet share progress" in current page administration
    Then I should see "Test Assignment 1" in the "Test Assignment 1" "table_row"
    And I should see "Assignment" in the "Test Assignment 1" "table_row"
