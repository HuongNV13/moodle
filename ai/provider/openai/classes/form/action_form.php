...
class action_form extends action_settings_form {
    ...
    public function set_data($default_values): void {
        if (isset($default_values['modelextraparams'])) {
    ...
    public function validation($data, $files): array {
        ...
        if (!empty($data['modelextraparams'])) {
            $extraparams = json_decode($data['modelextraparams']);
    ...
    protected function add_model_fields(): void {
        ...
        if (!empty($this->actionconfig['model']) && !array_key_exists($this->actionconfig['model'], $this->get_model_list())) {
            $defaultmodel = 'custom';
        } else {
