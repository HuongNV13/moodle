...
abstract class base {
    ...
    /**
     * Check if the model is compatible with image generation.
     *
     * @return bool Whether the model is compatible with image generation.
     */
    public function is_compatible_with_image(): bool {
        return false;
    }
}
