...
/**
 * Strings for component 'core\moodlenet', language 'en'
 *
...
$string['go_to_moodlenet'] = 'Go to MoodleNet drafts';
$string['share'] = 'Share';
$string['share_notice'] = 'You are sharing this to MoodleNet as a {$a}';
$string['share_fail_title'] = 'Something went wrong';
$string['share_fail_text'] = 'There was an error sharing your content to MoodleNet.<br>Please try again later or contact site support.';
$string['share_fail_text_with_site_support'] = 'There was an error sharing your content to MoodleNet.<br>Please try again later or <a href="{$a}">contact site support</a>.';
