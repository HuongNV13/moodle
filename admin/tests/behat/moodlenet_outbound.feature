...
Feature: MoodleNet outbound configuration
  ...
  Scenario: Outbound configuration without experimental flag enable yet
    Given I navigate to "General > MoodleNet" in site administration
  ...
  Scenario: Outbound configuration without OAuth 2 service setup yet
    ...
    When I navigate to "General > MoodleNet" in site administration
    ...
    And the "OAuth 2 service" "field" should be disabled
  ...
  Scenario: Outbound configuration with OAuth 2 service setup
    ...
    When I navigate to "General > MoodleNet > MoodleNet outbound settings" in site administration
    Then the "OAuth 2 service" "field" should be disabled
    And I navigate to "Server > OAuth 2 services" in site administration
