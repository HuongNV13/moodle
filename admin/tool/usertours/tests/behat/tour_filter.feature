...
Feature: Apply tour filters to a tour
  ...
  Scenario: Add a tour for a specific role
    ...
    And I add steps to the "First tour" tour:
      | targettype                | Title   | id_content                   | Content type | Content type |
      | Display in middle of page | Welcome | Welcome to your course tour. | HTML         | HTML         |
    And I log out
  ...
  Scenario: Add tour for a specific category and its subcategory
    ...
    And I add steps to the "First tour" tour:
      ...
      | Display in middle of page | Welcome | Welcome to your course tour. | HTML         |
    And I log out
    And I log in as "student1"
    When I am on "Course 1" course homepage
  ...
  Scenario: Add tours with CSS selectors
    ...
    And I add steps to the "Wiki tour" tour:
      | targettype                | Title   | id_content               | Content type |
      | Display in middle of page | Welcome | Welcome to the Wiki tour | HTML         |
    And I add a new user tour with:
      | Name               | Forum tour               |
      | Description        | A tour with both matches |
      | Apply to URL match | /course/view.php%        |
    ...
    And I add steps to the "Forum tour" tour:
      | targettype                | Title   | id_content                | Content type |
      | Display in middle of page | Welcome | Welcome to the Forum tour | HTML         |
    And I am on "Course 1" course homepage
  ...
  Scenario: Check filtering respects the sort order
    ...
    And I add steps to the "First tour" tour:
      | targettype                | Title   | id_content                | Content type |
      | Display in middle of page | Welcome | Welcome to the First tour | HTML         |
    And I add a new user tour with:
      | Name               | Second tour     |
    ...
    And I add steps to the "Second tour" tour:
      | targettype                | Title   | id_content                 | Content type |
      | Display in middle of page | Welcome | Welcome to the Second tour | HTML         |
    And I add a new user tour with:
      | Name               | Third tour     |
    ...
    And I add steps to the "Third tour" tour:
      | targettype                | Title   | id_content                | Content type |
      | Display in middle of page | Welcome | Welcome to the Third tour | HTML         |
