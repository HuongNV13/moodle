...
Feature: Add a new user tour
  ...
  Scenario: Add a new tour
    ...
    And I add steps to the "First tour" tour:
      ...
      | Display in middle of page | Welcome | Welcome to your personal learning space. We'd like to give you a quick tour to show you some of the areas you may find helpful | HTML         |
    And I add steps to the "First tour" tour:
      | targettype | targetvalue_block | Title    | id_content                                                                    | Content type |
      | Block      | Timeline          | Timeline | This is the Timeline. All of your upcoming activities can be found here       | HTML         |
      | Block      | Calendar          | Calendar | This is the Calendar. All of your assignments and due dates can be found here | HTML         |
    And I add steps to the "First tour" tour:
      | targettype | targetvalue_selector | Title     | id_content                                                                                         | Content type |
      | Selector   | .usermenu            | User menu | This is your personal user menu. You'll find your personal preferences and your user profile here. | HTML         |
  ...
  Scenario: Display step numbers was enabled
    ...
    And I add steps to the "Steps tour" tour:
      | targettype                | Title   | id_content             | Content type |
      | Display in middle of page | Welcome | First step of the Tour | HTML         |
    And I add steps to the "Steps tour" tour:
      | targettype | targetvalue_block | Title    | id_content              | Content type |
      | Block      | Timeline          | Timeline | Second step of the Tour | HTML         |
      | Block      | Calendar          | Calendar | Third step of the Tour  | HTML         |
    When I am on homepage
  ...
  Scenario: Single step tour with display step numbers was enable
    ...
    And I add steps to the "Steps tour" tour:
      | targettype                | Title   | id_content                 | Content type |
      | Display in middle of page | Welcome | This is a single step tour | HTML         |
    When I am on homepage
