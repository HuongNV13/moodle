...
$string['packaging'] = 'We\'re packaging your file';
...
$string['sharing'] = "Sharing your content to MoodleNet";
$string['sharing_to'] = "Sharing to: ";
$string['sharing_large_file'] = "Larger files can take some time.";
$string['share_fail_title'] = "Fail !";
$string['share_fail_text'] = "The content has not been shared to MoodleNet.";
$string['share_success_title'] = "All done !";
$string['share_success_text'] = "The content has been shared to MoodleNet.";
$string['view_in_moodle'] = "View in MoodleNet";
