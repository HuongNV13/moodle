...
class qtype_ddmarker_renderer extends qtype_ddtoimage_renderer_base {
    public function formulation_and_controls(question_attempt $qa,
        ...
        $output .= html_writer::start_div('droparea');
        ...
        $output .= html_writer::start_div('draghomes');
        ...
        foreach ($orderedgroup as $choiceno => $drag) {
            ...
            $dragoutput = html_writer::start_span(join(' ', $classes));
            ...
            $dragoutput .= html_writer::span($targeticonhtml . $markertext, '');
